...
export default function ComplaintManagement() {
  ...
  const depts = useMemo(() => [...new Set(complaints.map(c => c.department))], []);
  ...
  }, [search, statusFilter, priorityFilter, deptFilter]);
  ...
  return (
    <AnimatedPage><div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Button variant="outline" className="rounded-xl gap-2 shrink-0 w-full sm:w-auto" size="sm"><Download className="w-4 h-4 shrink-0" /> Export</Button>
      </div>
