  ...
  return (
    <AnimatedPage>
      <div className="space-y-6 max-w-3xl">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Staff Profile</h1>
          <p className="text-muted-foreground mt-1 text-sm sm:text-base">
            Your hospital identity and contact details shown to patients on responses.
          </p>
        </div>
        ...
        <Card className="rounded-2xl">
          ...
          <CardContent className="space-y-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground">{user?.name ?? 'Staff'}</p>
